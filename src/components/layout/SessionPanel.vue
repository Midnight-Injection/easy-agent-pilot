...
import type { SessionPanelProps } from './sessionPanel/useSessionPanel'
import { useSessionPanelView } from './sessionPanel/useSessionPanel'
...
<style scoped src="./sessionPanel/styles.css"></style>
